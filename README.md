...
- week5
  - 練習1
    ...
    ![ex1_question](./week5/ex1.jpg)
  - 練習2
    > $x_0 = 1, \alpha = 1\degree, \alpha’ = ?$
    ![ex2_question](./week5/ex2.jpg)
  - 練習3
    > $$\begin{equation}
    M_{Lens} = 
    \left(\begin{array}{cc} a & b\\ c & d \end{array}\right)
    \end{equation}$$a = ?, b = ?, c = ?, d = ?
    ![ex3_question](./week5/ex3.jpg)
  - 作業4
    > 如下圖的雙薄透鏡系統。試寫一程式，求出 x, 𝛼
    ![hw4_question](./week5/hw4.jpg)
...
- week8
  ...
  - 練習2
    > 參考前頁程式碼，繪出右圖
    ![ex2_question](./week8/ex2.png)
  - 練習3
    > 仿照前頁點源干涉的原理及程式，繪出如右圖的干涉圖樣
    ![ex3_question](./week8/ex3.png)
  - 練習4
...
- week9
  - 練習1
    ...
    ![ex1_question](./week9/ex1.png)
  - 練習2
    > 將彩色的lena旋轉45度
  - 練習3
    > 將下圖的座標軸轉換成正交
    ![ex3_question](./week9/coinOnDesk.jpg)
